...
public class Producto {
    ...
    public Producto(String ID_Producto, double Precio, String Nombre, String Descripcion, String DisponibleEnVlc, String DisponibleEnZgz, String ID_Categoria_pro) {
