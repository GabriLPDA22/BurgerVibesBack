...
public class DetallesPagoDao implements IDao<DetallesPago,String> {
    private final String SQL_FIND_ALL = "SELECT * FROM DETALLESPAGO WHERE 1=1 ";

    @Override
    public int add(DetallesPago bean) {
    ...
    @Override
    public int update(DetallesPago bean) {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public ArrayList<DetallesPago> findAll(DetallesPago bean) {
